...
if __name__ == "__main__":
    ...
    # You can adjust model parameters here and in the GPT2RGAX module to your specs
    ...
    # To uncomment if pickle version doesnt work
    ...
    class MusicSamplerDataset(Dataset):
        ...
        def __getitem__(self, index):
            rand = secrets.randbelow((self.data.size(0) - (self.seq_len + 1)) // (self.seq_len + 1)) * (
                        self.seq_len + 1)
