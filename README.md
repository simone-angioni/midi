...
- converted_original_song_title : Original song converted with our utils from where the priming part is from
- converted_prime_tokens : Extract of the original song used to prime our model to generate the continuation block
- converted_continuation_block : original part generated by our model as continuation of the priming part
- converted_final_composition : final song generated by our model composed by the prime part of the original song and the continuation block

Moreover, along with the original song and the excerpt all converted the generator script will create a *parameters.txt* file with the following information about the generated song:
